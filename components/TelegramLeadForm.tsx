...
const leadFormCopy: Record<LocaleCode, LeadFormCopy> = {
  de: {
    ...
    description:
      "Beschreiben Sie kurz Ihr Elektroproblem. Wir bereiten eine schnelle Rückmeldung vor und leiten Ihre Anfrage über Telegram weiter.",
    nameLabel: "Name",
    namePlaceholder: "Ihr Name",
    contactLabel: "Telefon oder E-Mail",
    contactPlaceholder: "Wie dürfen wir Sie erreichen?",
    cityLabel: "Stadt",
    cityPlaceholder: "z. B. Berlin",
    serviceLabel: "Service",
    servicePlaceholder: "Bitte Service wählen",
    serviceOptions: [
    ...
    submitIdle: "Über Telegram anfragen",
    submitBusy: "Anfrage wird vorbereitet...",
    success: "Ihre Anfrage ist vorbereitet. Telegram wurde in einem neuen Tab geöffnet.",
    fallbackInfo:
      "Ihre Anfrage ist vorbereitet. Telegram konnte nicht geöffnet werden. Bitte versuchen Sie es erneut.",
