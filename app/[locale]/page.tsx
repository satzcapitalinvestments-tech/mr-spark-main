...
const copy: Record<string, { title: string; lead: string; services: string[] }> = {
  en: { title: "Mr Spark — Electrician & Emergency Electrical Service", lead: "Fast help for power outages, short circuits, fuse box issues, sockets, lighting installation and planned electrical work. Send your request, receive a quick response and clarify the next step transparently.", services: ["Electrician", "Electrical installation", "Emergency electrical service", "Fuse box", "Sockets", "Lighting", "Power outage"] },
