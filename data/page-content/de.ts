export const homePageContent = {
  ...
  services: [
    ...
    },
    {
      ...
      description:
        "Austausch, Erweiterung und Kontrolle von Schutzorganen, Automaten und Verteilern mit Blick auf Sicherheit.",
    },
    {
      badge: "Innenraum",
  ...
  pricingCards: [
    {
      title: "Anfahrt & Einsatzort",
      description:
        "Anfahrt wird offen angesprochen und haengt von Region, Entfernung und Einsatzzeit ab.",
    },
    {
      title: "Diagnose & Arbeitszeit",
      description:
        "Fehlersuche und Arbeitszeit bleiben als nachvollziehbare Leistungsbausteine sichtbar.",
    },
    {
      title: "Material & Notdienst",
      description:
        "Materialbedarf sowie Nacht-, Wochenend- oder Feiertagszuschlaege werden vorab klar benannt.",
    },
  ],
  faq: [
    {
...
export const emergencyPageContent = {
  ...
  symptoms: [
    ...
    },
    {
      ...
      description: "Warme Steckdosen, verfärbte Abdeckungen, Lichtausfall oder Brandgeruch an Leitungen.",
    },
  ],
  steps: [
    {
  ...
  pricing: [
    {
      title: "Anfahrt",
      description: "Die Einsatzanfahrt bleibt als eigener Kostenblock sichtbar und wird nicht versteckt.",
    },
    {
      title: "Diagnose",
    ...
    },
    {
      ...
      description: "Nacht-, Feiertags- und Wochenendzuschlaege werden vor Beginn offen angesprochen.",
    },
  ],
  faq: [
    {
  ...
  pillars: [
    {
      ...
      title: "Anfahrt",
      description: "Die Anfahrt wird je nach Region, Entfernung und Einsatzzeit transparent eingeordnet.",
    },
    {
      badge: "Kostenbaustein",
